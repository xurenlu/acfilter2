srcdir = /Users/renlu/Dev/php-5.4.18/ext/acfilter
builddir = /Users/renlu/Dev/php-5.4.18/ext/acfilter
top_srcdir = /Users/renlu/Dev/php-5.4.18/ext/acfilter
top_builddir = /Users/renlu/Dev/php-5.4.18/ext/acfilter
...
RE2C = exit 0;
AWK = awk
shared_objects_acfilter = acfilter.lo acseg_rbtree.lo acseg_tree.lo acseg_util.lo exists.lo mem_collector.lo
PHP_PECL_EXTENSION = acfilter
PHP_MODULES = $(phplibdir)/acfilter.la
PHP_ZEND_EX =
all_targets = $(PHP_MODULES) $(PHP_ZEND_EX)
install_targets = install-modules install-headers
prefix = /usr/local/Cellar/php54/5.4.15
exec_prefix = $(prefix)
libdir = ${exec_prefix}/lib
prefix = /usr/local/Cellar/php54/5.4.15
phplibdir = /Users/renlu/Dev/php-5.4.18/ext/acfilter/modules
phpincludedir = /usr/local/Cellar/php54/5.4.15/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
PHP_EXECUTABLE = /usr/local/Cellar/php54/5.4.15/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/local/Cellar/php54/5.4.15/include/php -I/usr/local/Cellar/php54/5.4.15/include/php/main -I/usr/local/Cellar/php54/5.4.15/include/php/TSRM -I/usr/local/Cellar/php54/5.4.15/include/php/Zend -I/usr/local/Cellar/php54/5.4.15/include/php/ext -I/usr/local/Cellar/php54/5.4.15/include/php/ext/date/lib
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
